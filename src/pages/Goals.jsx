...
function Goals() {
  ...
  return (
    <Container className='flex flex-col  justify-between w-full'>
    <div className='w-full flex flex-col items-center justify-center gap-6'>
      ...
      <div className='w-full flex flex-col items-center justify-start gap-3'>
        {goals.map((goal, index) => <div key={index} className='w-[90%] bg-[#F1F1F1] p-4 rounded-lg flex items-center justify-between'>
          <label htmlFor={goal} className='cursor-pointer font-medium text-sm'>{goal}</label>
      ...
      <NavLink to='/android9' className='w-full flex items-center justify-center mb-8'>

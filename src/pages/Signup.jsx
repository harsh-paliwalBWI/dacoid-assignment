...
function Signup() {
  return (
    <Container className='flex flex-col items-center h-full justify-between gap-28 '>
    <div className=' w-[90%]'>
      <h1 className='font-bold  text-[#2C2B2B] mt-4 self-start  my-8 text-xl sm:text-2xl'>Create an account</h1>
      <form className='flex flex-col items-center justify-center h-[50%] gap-6 w-full'>
        ...
        <div className='flex items-center justify-center '>
          ...
          <label htmlFor="cb" className='text-[13px] text-[#7F7F7F] cursor-pointer'>By proceeding, I agree to all <span className='text-[#9FB2FF] underline'>T&C</span> and  <span className='text-[#9FB2FF] underline'>Privacy Policy</span></label>
        </div>
      </form>
      </div>
      <div className=' flex flex-col items-center gap-3 mb-4'>
      <NavLink to='/android6' className='w-full flex items-center justify-center'><Button className='w-[90%] h-[50px] rounded-lg'>
        <p className='text-sm sm:text-base'>Create an Account</p>
      </Button></NavLink>
